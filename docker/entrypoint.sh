...
generate_runtime_config() {
  ...
  export REACT_APP_OIDC_CLIENT_ID="${REACT_APP_OIDC_CLIENT_ID:-client_0332rO37uKM9DoNPvapSDX}"
  envsubst </etc/caddy/runtime-config.js.template >/usr/share/caddy/runtime-config.v3.js
}
